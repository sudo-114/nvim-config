...
<a href="https://dotfyle.com/sudo-114/nvim-config"><img src="https://dotfyle.com/sudo-114/nvim-config/badges/plugins?style=flat" /></a>
<a href="https://dotfyle.com/sudo-114/nvim-config"><img src="https://dotfyle.com/sudo-114/nvim-config/badges/leaderkey?style=flat" /></a>
<a href="https://dotfyle.com/sudo-114/nvim-config"><img src="https://dotfyle.com/sudo-114/nvim-config/badges/plugin-manager?style=flat" /></a>
...
```sh
git clone git@github.com:sudo-114/nvim-config ~/.config/sudo-114/nvim-config
```

Open Neovim with this config:

```sh
NVIM_APPNAME=sudo-114/nvim-config/ nvim
```

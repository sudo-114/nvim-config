...
opt.statuscolumn = "" -- defines the content shown in the *status column* (the column to the left of the text area).

-- Folding
opt.foldmethod = "syntax" -- use syntax for folding (alternatives: "syntax","indent", "manual")
